...
sudo mkdir apache2
sudo a2dismod php7
sudo cp /usr/lib/apache2/modules/libphp7.so /etc/apache2/mods-available/php7.load apache2/
sudo rm /usr/lib/apache2/modules/libphp7.so /etc/apache2/mods-available/php7.load
sudo chmod -x apache2/*
sudo ./bin/pecl install apcu xdebug
sudo chmod -x lib/php/20151012/*
...
[opcache]
zend_extension=\"/usr/local/php/7.0/lib/php/20151012/opcache.so\"
opcache.enable=1
...
[xdebug]
zend_extension=\"/usr/local/php/7.0/lib/php/20151012/xdebug.so\"
